...
<head>
    ...
    <title>Register - Examination Timetable Allocation System</title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <div class="text-center m-2"><a class="small" href="login.php">Already have an account? Click to Login!</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
